...
title: "Week #19 | Discussion Questions"

cover:
    image: "https://images.unsplash.com/photo-1615149596797-da241c6f8e30?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" # e.g., "img/hugo_logo_wide.svg" or "https://example.com/image.jpg"
    alt: "farm" # Optional: Add alt text for accessibility
...
Tim Keller teaches that humility is not thinking less of yourself but thinking of yourself less. Pastor Jeff noted that ego leaves you empty, hurt, busy, and fragile.
...
Pastor Jeff's points out that we must accept the necessity of a healthy dependency of one another. In our church today, we find a balance between ministry and management—both together are required for a faithful and healthy church.
* How have we experienced dependency on other church members for our ministry?
* How can we encourage those we depend on as we all work together for the glory of God?

### Question 6

Lastly, Pastor Jeff teaches that we must let Jesus' commendation be our ultimate reward. Paul wrote that each person would receive the wages for his labor, not for his harvest. Therefore, our task to to be faithful to Jesus and let God give the growth of fruit. We should find our reward in this faithfulness. 
* Do you struggle to find your reward in your faithfulness to Christ instead of in the result of your work?
* What does that look like for your area(s) of service?
